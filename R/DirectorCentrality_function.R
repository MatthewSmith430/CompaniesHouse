#' @title One-Mode Directors Network Centrality Table
#'
#' @description This function calculates a number of centrality metrics for the director to director network.
#' @param gs Director Network (igraph object)
#' @export
#' @return One-Mode Directors Network Centrality Table Data frame
DirectorCentrality<-function(gs){
